...
QtObject {
    ...
    property real uiAnimationScale: 0.72
    ...
    property int scrollThrottleMs: 70
    property int filterAnimationMs: 360
    property int itemAnimationMs: 240
