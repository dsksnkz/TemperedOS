# QS Wallpaper Picker — upstream notice

Tempered OS vendors and adapts
[magetsu002/qs-wallpaper-picker](https://github.com/magetsu002/qs-wallpaper-picker)
at commit `c81fe1d4c3485b7dc39e0cd0aa82ccc6228ed9f6`.

The included `LICENSE` is the upstream MIT license. Tempered OS changes the
default wallpaper directory, motion timing, application command, Waypaper
backend, and palette handoff. Refer to the upstream repository for its complete
documentation and contribution history.

<!-- The upstream README below is retained for operational documentation. -->
