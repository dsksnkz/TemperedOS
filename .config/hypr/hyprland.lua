...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("systemd-run --user --unit=tempered-power-init --collect ~/.local/bin/tempered-power-init")
    hl.exec_cmd("swaync")
...
hl.bind(mod .. " + SHIFT + P", hl.dsp.exec_cmd("~/.local/bin/tempered-power"))
